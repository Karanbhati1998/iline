...
import { addRole, editRole } from "../../features/slices/subAdmin";
...
const EditRole = () => {
      ...
      permission: prevState.permission.map((module) =>
        module.name === moduleName
          ? {
              ...module,
              [type]: !module[type],
              ...(type === "fullAccess" && { read: !module[type] }), // If fullAccess is toggled, read should match
            }
          : module
      ),
    }));
  ...
  const handleSubmit = () => {
    if (title.trim()) {
      dispatch(editRole(iState)).then((res) => {
