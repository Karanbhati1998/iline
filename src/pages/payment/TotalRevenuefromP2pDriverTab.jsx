...
const TotalRevenuefromP2pDriverTab = ({ categoryId }) => {
  ...
  useEffect(() => {
    ...
    if (categoryId) {
      dispatch(getP2pRevenueListDownload(data)).then((res) => {
  ...
  const handleReset = () => {
    ...
    dispatch(getP2pRevenueList({ categoryId, revenueType: "ILINE", page: 1 }));
  };
  const handleApply = () => {
    const data = {
      search,
    ...
    dispatch(getP2pRevenueList(data));
  };
  return (
    <>
      <div
        ...
        <div className="Small-Wrapper">
          <div className="FilterArea">
            ...
            <div className="FilterRight">
              <ExportToExcel ref={totalRevenueP2pRef} fileName="ilineDriver" />
            </div>
          </div>
          <div className="TableList mt-4" style={{ display: "none" }}>
            <table style={{ width: "150%" }} ref={totalRevenueP2pRef}>
              <thead>
                <tr>
                  <th>S.No.</th>
                  <th>Booking ID</th>
...
export default TotalRevenuefromP2pDriverTab;
